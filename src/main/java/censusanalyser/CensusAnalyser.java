...
public class CensusAnalyser {
    ...
    public String getRunsSortedData() throws CensusAnalyserException {
        if (IPLBattingRecordList == null || IPLBattingRecordList.size() == 0) {
            throw new CensusAnalyserException("No Batting Data", CensusAnalyserException.ExceptionType.NO_BATTING_DATA);
        }
        Comparator<IPL2019BattingRecordCSV> battingRecordCSVComparator = Comparator.comparing(battingRecordCSV -> battingRecordCSV.runs);
        this.sortBatting(battingRecordCSVComparator);
        String sortedStateCensusJson = new Gson().toJson(IPLBattingRecordList);
        return sortedStateCensusJson;
    }
    ...
    public String getStrikeRateWiseSortedData() throws CensusAnalyserException {
        if (IPLBowlingRecordList == null || IPLBowlingRecordList.size() == 0) {
            throw new CensusAnalyserException("No Bowling Data", CensusAnalyserException.ExceptionType.NO_BATTING_DATA);
        }
        Comparator<IPL2019BowlingRecordCSV> bowlingRecordCSVComparator = Comparator.comparing(bowlingRecordCSV -> bowlingRecordCSV.strikeRate);
        this.sortBowling(bowlingRecordCSVComparator);
        String sortedStateCensusJson = new Gson().toJson(IPLBowlingRecordList);
        return sortedStateCensusJson;
    }

    public String getEconomySortedData() throws CensusAnalyserException{
        if (IPLBowlingRecordList == null || IPLBowlingRecordList.size() == 0) {
            throw new CensusAnalyserException("No Bowling Data", CensusAnalyserException.ExceptionType.NO_BATTING_DATA);
        }
        Comparator<IPL2019BowlingRecordCSV> bowlingRecordCSVComparator = Comparator.comparing(bowlingRecordCSV -> bowlingRecordCSV.economy);
        this.sortBowling(bowlingRecordCSVComparator);
        String sortedStateCensusJson = new Gson().toJson(IPLBowlingRecordList);
        return sortedStateCensusJson;
    }
